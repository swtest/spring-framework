...
public abstract class SpringDbUnitTestCase {
     ...
     *
     * @return 테스트데이터 XML 리소스 위치. <br/>
     *         예) kr/co/swtest/customerentity/dao/sqlmap/xxx.xml
     */
    ...
    private IDatabaseConnection getConnection() throws Exception {
        DatabaseConnection connection = new DatabaseConnection(this.dataSource.getConnection(), getSchemaName());
